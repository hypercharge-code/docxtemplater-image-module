...
module.exports = /*#__PURE__*/function () {
  ...
  return _createClass(ImgManager, [{
    ...
    key: "addImageRels",
    value: function addImageRels(imageName, imageData, imgProps, i) {
      if (i == null) {
        i = 0;
      }
      ...
      if (imgProps) {
        var imgLink = imgProps.link;
        this.addHyperLinkRels(imgLink, maxRid + 1);
      }
      return maxRid;
    }
  }, {
    key: "addHyperLinkRels",
    value: function addHyperLinkRels(hyperLink, rId) {
      var relationships = this.relsDoc.getElementsByTagName("Relationships")[0];
      var newTag = this.relsDoc.createElement("Relationship");
      newTag.namespaceURI = "http://schemas.openxmlformats.org/package/2006/relationships";
      newTag.setAttribute("Id", "rId".concat(rId));
...
function getImageTag(rId, insertHyperLink) {
  if (insertHyperLink) {
    return "<wp:docPr id=\"2\" name=\"Image 2\" descr=\"image\">\n\t<a:hlinkClick xmlns:a=\"http://schemas.openxmlformats.org/drawingml/2006/main\" r:id=\"rId".concat(rId + 1, "\"/>\n</wp:docPr>");
  }
  return "<wp:docPr descr=\"image\" id=\"2\" name=\"Image 2\"/>";
}
module.exports = {
  getImageXml: function getImageXml(rId, size, insertHyperLink) {
    return "<w:drawing>\n\t\t<wp:inline distT=\"0\" distB=\"0\" distL=\"0\" distR=\"0\">\n\t\t\t<wp:extent cx=\"".concat(size[0], "\" cy=\"").concat(size[1], "\"/>\n\t\t\t<wp:effectExtent l=\"0\" t=\"0\" r=\"0\" b=\"0\"/>\n\t\t\t").concat(getImageTag(rId, insertHyperLink), "\n\t\t\t<wp:cNvGraphicFramePr>\n\t\t\t\t<a:graphicFrameLocks xmlns:a=\"http://schemas.openxmlformats.org/drawingml/2006/main\" noChangeAspect=\"1\"/>\n\t\t\t</wp:cNvGraphicFramePr>\n\t\t\t<a:graphic xmlns:a=\"http://schemas.openxmlformats.org/drawingml/2006/main\">\n\t\t\t\t<a:graphicData uri=\"http://schemas.openxmlformats.org/drawingml/2006/picture\">\n\t\t\t\t\t<pic:pic xmlns:pic=\"http://schemas.openxmlformats.org/drawingml/2006/picture\">\n\t\t\t\t\t\t<pic:nvPicPr>\n\t\t\t\t\t\t\t<pic:cNvPr id=\"0\" name=\"Picture 1\" descr=\"image\"/>\n\t\t\t\t\t\t\t<pic:cNvPicPr>\n\t\t\t\t\t\t\t\t<a:picLocks noChangeAspect=\"1\" noChangeArrowheads=\"1\"/>\n\t\t\t\t\t\t\t</pic:cNvPicPr>\n\t\t\t\t\t\t</pic:nvPicPr>\n\t\t\t\t\t\t<pic:blipFill>\n\t\t\t\t\t\t\t<a:blip r:embed=\"rId").concat(rId, "\">\n\t\t\t\t\t\t\t\t<a:extLst>\n\t\t\t\t\t\t\t\t\t<a:ext uri=\"{28A0092B-C50C-407E-A947-70E740481C1C}\">\n\t\t\t\t\t\t\t\t\t\t<a14:useLocalDpi xmlns:a14=\"http://schemas.microsoft.com/office/drawing/2010/main\" val=\"0\"/>\n\t\t\t\t\t\t\t\t\t</a:ext>\n\t\t\t\t\t\t\t\t</a:extLst>\n\t\t\t\t\t\t\t</a:blip>\n\t\t\t\t\t\t\t<a:srcRect/>\n\t\t\t\t\t\t\t<a:stretch>\n\t\t\t\t\t\t\t\t<a:fillRect/>\n\t\t\t\t\t\t\t</a:stretch>\n\t\t\t\t\t\t</pic:blipFill>\n\t\t\t\t\t\t<pic:spPr bwMode=\"auto\">\n\t\t\t\t\t\t\t<a:xfrm>\n\t\t\t\t\t\t\t\t<a:off x=\"0\" y=\"0\"/>\n\t\t\t\t\t\t\t\t<a:ext cx=\"").concat(size[0], "\" cy=\"").concat(size[1], "\"/>\n\t\t\t\t\t\t\t</a:xfrm>\n\t\t\t\t\t\t\t<a:prstGeom prst=\"rect\">\n\t\t\t\t\t\t\t\t<a:avLst/>\n\t\t\t\t\t\t\t</a:prstGeom>\n\t\t\t\t\t\t\t<a:noFill/>\n\t\t\t\t\t\t\t<a:ln>\n\t\t\t\t\t\t\t\t<a:noFill/>\n\t\t\t\t\t\t\t</a:ln>\n\t\t\t\t\t\t</pic:spPr>\n\t\t\t\t\t</pic:pic>\n\t\t\t\t</a:graphicData>\n\t\t\t</a:graphic>\n\t\t</wp:inline>\n\t</w:drawing>\n\t\t").replace(/\t|\n/g, "");
  },
  getImageXmlCentered: function getImageXmlCentered(rId, size, insertHyperLink) {
    return "<w:p>\n\t\t\t<w:pPr>\n\t\t\t\t<w:jc w:val=\"center\"/>\n\t\t\t</w:pPr>\n\t\t\t<w:r>\n\t\t\t\t<w:rPr/>\n\t\t\t\t<w:drawing>\n\t\t\t\t\t<wp:inline distT=\"0\" distB=\"0\" distL=\"0\" distR=\"0\">\n\t\t\t\t\t<wp:extent cx=\"".concat(size[0], "\" cy=\"").concat(size[1], "\"/>\n\t\t\t\t\t<wp:docPr id=\"0\" name=\"Picture\" descr=\"\">\n\t\t\t\t\t\t").concat(insertHyperLink ? "<a:hlinkClick xmlns:a=\"http://schemas.openxmlformats.org/drawingml/2006/main\" r:id=\"rId" + (rId + 1) + "\"/>" : "", "\n\t\t\t\t\t</wp:docPr>\n\t\t\t\t\t<a:graphic xmlns:a=\"http://schemas.openxmlformats.org/drawingml/2006/main\">\n\t\t\t\t\t\t<a:graphicData uri=\"http://schemas.openxmlformats.org/drawingml/2006/picture\">\n\t\t\t\t\t\t<pic:pic xmlns:pic=\"http://schemas.openxmlformats.org/drawingml/2006/picture\">\n\t\t\t\t\t\t\t<pic:nvPicPr>\n\t\t\t\t\t\t\t<pic:cNvPr id=\"0\" name=\"Picture\" descr=\"\"/>\n\t\t\t\t\t\t\t<pic:cNvPicPr>\n\t\t\t\t\t\t\t\t<a:picLocks noChangeAspect=\"1\" noChangeArrowheads=\"1\"/>\n\t\t\t\t\t\t\t</pic:cNvPicPr>\n\t\t\t\t\t\t\t</pic:nvPicPr>\n\t\t\t\t\t\t\t<pic:blipFill>\n\t\t\t\t\t\t\t<a:blip r:embed=\"rId").concat(rId, "\"/>\n\t\t\t\t\t\t\t<a:stretch>\n\t\t\t\t\t\t\t\t<a:fillRect/>\n\t\t\t\t\t\t\t</a:stretch>\n\t\t\t\t\t\t\t</pic:blipFill>\n\t\t\t\t\t\t\t<pic:spPr bwMode=\"auto\">\n\t\t\t\t\t\t\t<a:xfrm>\n\t\t\t\t\t\t\t\t<a:off x=\"0\" y=\"0\"/>\n\t\t\t\t\t\t\t\t<a:ext cx=\"").concat(size[0], "\" cy=\"").concat(size[1], "\"/>\n\t\t\t\t\t\t\t</a:xfrm>\n\t\t\t\t\t\t\t<a:prstGeom prst=\"rect\">\n\t\t\t\t\t\t\t\t<a:avLst/>\n\t\t\t\t\t\t\t</a:prstGeom>\n\t\t\t\t\t\t\t<a:noFill/>\n\t\t\t\t\t\t\t<a:ln w=\"9525\">\n\t\t\t\t\t\t\t\t<a:noFill/>\n\t\t\t\t\t\t\t\t<a:miter lim=\"800000\"/>\n\t\t\t\t\t\t\t\t<a:headEnd/>\n\t\t\t\t\t\t\t\t<a:tailEnd/>\n\t\t\t\t\t\t\t</a:ln>\n\t\t\t\t\t\t\t</pic:spPr>\n\t\t\t\t\t\t</pic:pic>\n\t\t\t\t\t\t</a:graphicData>\n\t\t\t\t\t</a:graphic>\n\t\t\t\t\t</wp:inline>\n\t\t\t\t</w:drawing>\n\t\t\t</w:r>\n\t\t</w:p>\n\t\t").replace(/\t|\n/g, "");
  },
...
},{"./errors.js":15,"./utils.js":36,"@xmldom/xmldom":8}],13:[function(require,module,exports){
"use strict";
...
},{"./collect-content-types.js":10,"./doc-utils.js":12,"./error-logger.js":14,"./errors.js":15,"./file-type-config.js":16,"./lexer.js":20,"./module-wrapper.js":22,"./modules/common.js":23,"./scope-manager.js":34,"./traits.js":35,"./xml-matcher.js":37,"./xml-templater.js":38}],14:[function(require,module,exports){
"use strict";
...
},{"./modules/expand-pair-trait.js":24,"./modules/loop.js":25,"./modules/rawxml.js":26,"./modules/render.js":27,"./modules/space-preserve.js":28}],17:[function(require,module,exports){
"use strict";
...
},{"./doc-utils.js":12,"./filetypes.js":17}],20:[function(require,module,exports){
"use strict";
...
},{"./doc-utils.js":12,"./errors.js":15}],21:[function(require,module,exports){
"use strict";
...
},{"./errors.js":15}],23:[function(require,module,exports){
"use strict";
...
},{"../content-types.js":11,"../filetypes.js":17,"../module-wrapper.js":22}],24:[function(require,module,exports){
"use strict";
...
},{"../doc-utils.js":12,"../errors.js":15,"../merge-sort.js":21,"../module-wrapper.js":22,"../traits.js":35}],25:[function(require,module,exports){
"use strict";
...
},{"../doc-utils.js":12,"../filetypes.js":17,"../module-wrapper.js":22}],26:[function(require,module,exports){
"use strict";
...
},{"../doc-utils.js":12,"../errors.js":15,"../module-wrapper.js":22,"../traits.js":35}],27:[function(require,module,exports){
"use strict";
...
},{"../content-types.js":11,"../doc-utils.js":12,"../errors.js":15,"../module-wrapper.js":22}],28:[function(require,module,exports){
"use strict";
...
},{"../doc-utils.js":12,"../module-wrapper.js":22}],29:[function(require,module,exports){
"use strict";
...
},{"./doc-utils.js":12,"./prefix-matcher.js":31}],30:[function(require,module,exports){
"use strict";
...
},{"./errors.js":15,"./get-resolved-id.js":18}],33:[function(require,module,exports){
"use strict";
...
},{"./get-resolved-id.js":18}],34:[function(require,module,exports){
"use strict";
...
},{"./doc-utils.js":12,"./errors.js":15,"./utils.js":36}],35:[function(require,module,exports){
"use strict";
...
},{"./doc-utils.js":12,"./errors.js":15}],36:[function(require,module,exports){
"use strict";
...
},{"./doc-utils.js":12}],38:[function(require,module,exports){
"use strict";
